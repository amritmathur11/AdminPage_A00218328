<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="Web.Signup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h3>
        <asp:Label ID="lbl_msg" runat="server" Text=""></asp:Label></h3>
    ...
    <div class="panel panel-warning">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label>Phone * (0000000000)</label>
                    <asp:TextBox MinLength="11" MaxLength="13" ID="txt_phone" ValidationGroup="ORDER" CssClass="form-control" runat="server" TextMode="Phone"></asp:TextBox>
